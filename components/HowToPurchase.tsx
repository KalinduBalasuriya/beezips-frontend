      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-16 py-24 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            <div className=" rounded-md p-8 lg:p-10">
              ...
              <div className="grid grid-cols-2 gap-3">
                {areas.map((a) => (
                  <div
                    key={a}
                    className="flex items-center gap-3 text-ink/85 text-sm border-b border-cream/10 pb-3"
                  >
            ...
            <div className="bg-ink rounded-md p-5">
...
function Step({
  ...
  return (
    <li className="flex gap-3">
      <span className="font-display text-honey-deep/50 text-xl font-700 leading-none">
        {n}
      </span>
      <div>
        <h4 className="font-700 text-ink mb-1 leading-none">{title}</h4>
